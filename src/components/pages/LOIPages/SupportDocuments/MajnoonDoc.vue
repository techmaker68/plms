...
<template>
  <DefineTemplate>
    <MajnoonContent :application="application" :applicants="applicants" />
  </DefineTemplate>

  <div class="document-align">
    <!-- <div class="letter-view mx-auto"> -->
...
import MajnoonContent from "../PdfContent/MajnoonContent.vue";
...
export default defineComponent({
  ...
  computed: {
    ...
    downloadedFileName() {
      let fileName = `${
        this.application?.majnoon_ref ? this.application?.majnoon_ref + "-" : ""
      }Majnoon`;
      if (this.batchNumber) {
